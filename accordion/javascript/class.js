class Accordion {
	...
	toggleAccordion(accordion) {
		const accordionAccordion = accordion.nextElementSibling;

		accordion.classList.toggle("accordion--active");
		accordionAccordion.classList.toggle("accordion-message--active");
		this.hidePreviousAccordion(accordionAccordion);
	}
